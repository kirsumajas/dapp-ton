...
const TransactionHistory: React.FC<Props> = ({ telegramId }) => {
  ...
  return (
    <div className="mt-6 bg-[#2e2c33] rounded-xl p-4 text-white h-[50vh] flex flex-col">
      <h3 className="text-lg font-semibold mb-4 flex-shrink-0">Transaction History</h3>
